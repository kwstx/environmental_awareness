...
export class GlobalSystemState {
  ...
  constructor(data: GlobalSystemStateData) {
    ...
    this.metrics = {
      totalTreasuryReserves: data.metrics.totalTreasuryReserves,
      pooledBudgetUtilization: data.metrics.pooledBudgetUtilization,
      aggregateAgentRiskExposure: data.metrics.aggregateAgentRiskExposure,
      networkComputeLoad: data.metrics.networkComputeLoad,
      policyViolationFrequency: data.metrics.policyViolationFrequency,
      cooperativeEfficiencyScores: data.metrics.cooperativeEfficiencyScores,
      ongoingTaskDensity: data.metrics.ongoingTaskDensity,
      // Spread any additional indicators for extensibility
      ...data.metrics
    };
